...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::targetPosition(FLOAT x, FLOAT y,
                                                                                  FLOAT z) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::upVector(FLOAT x, FLOAT y,
                                                                            FLOAT z) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::orbitHomePosition(FLOAT x,
                                                                                     FLOAT y,
                                                                                     FLOAT z) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::mapExtent(FLOAT worldWidth,
                                                                             FLOAT worldHeight) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::flightStartPosition(FLOAT x,
                                                                                       FLOAT y,
                                                                                       FLOAT z) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::flightStartOrientation(
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::flightMaxMoveSpeed(
    FLOAT maxSpeed) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::flightPanSpeed(FLOAT x,
                                                                                  FLOAT y) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::flightMoveDamping(
    FLOAT damping) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::groundPlane(FLOAT a, FLOAT b,
                                                                               FLOAT c, FLOAT d) {
...
template <typename FLOAT>
typename Manipulator<FLOAT>::Builder& Manipulator<FLOAT>::Builder::raycastCallback(RayCallback cb,
                                                                                   void* userdata) {
...
template <typename FLOAT>
bool Manipulator<FLOAT>::raycastGroundPlane(int x, int y, vec3* result) const {
  vec3 origin, dir;
  getRay(x, y, &origin, &dir);
  // Choose either the user's callback function or the plane intersector.
  auto fallback = raycastPlane<FLOAT>;
  void* userdata = mProps.raycastUserdata;
  FLOAT t;
  fallback(mEye, dir, &t, (void*)&mProps);
